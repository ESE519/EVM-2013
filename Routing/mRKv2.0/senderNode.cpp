...
{   
	  //std::map<int fromMole, uint8_t ttl> slavesMap;
...
void checkSlaves(char *r_buf){
	int fromMole=r_buf[0];
	int TTL=30;
...
void nrk_create_taskset ()
{
    ...
    SD_TASK.cpu_reserve.nano_secs = 900 * NANOS_PER_MS;
